...
namespace Da.controller
{
    ...
    {
        public connect conn;
        private DM_NhanVien nhanvien;
        public them_nhanvien(connect _conn, DM_NhanVien _nhanvien)
        {
            InitializeComponent();
            conn = _conn;
            nhanvien = _nhanvien;
        ...
        int kiemtra_thongtin()
        {
            ...
            else if (txt_cmnd.Text.Length > 12)
            {
        ...
        private void them_thong_tin_nhan_vien()
        {
            try
            {
                ...
                if (kq_kt == 1)
                {
                    ...
                    insert_New["NGAYSINH"] = dateTimePicker_ngaysinh.Value;
